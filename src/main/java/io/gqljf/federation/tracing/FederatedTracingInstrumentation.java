...
public class FederatedTracingInstrumentation extends SimpleInstrumentation {
    ...
    public InstrumentationState createState(InstrumentationCreateStateParameters parameters) {
        ...
        if (context instanceof HTTPRequestHeaders) {
            String headerValue = ((HTTPRequestHeaders) context).getHTTPRequestHeader(HEADER_NAME);
    ...
    public CompletableFuture<ExecutionResult> instrumentExecutionResult(ExecutionResult executionResult, InstrumentationExecutionParameters parameters) {
        final FederatedTracingState state = parameters.<FederatedTracingState>getInstrumentationState();
        if (state == null) {
