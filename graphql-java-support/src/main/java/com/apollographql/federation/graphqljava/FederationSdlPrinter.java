...
public class FederationSdlPrinter {
  ...
  public static class Options {
    ...
    /**
     * Filter printing of directive definitions. In Apollo Federation, some directive definitions
     * need to be hidden, and this predicate allows filtering out such definitions. Prints all
     * definitions by default. Note that this predicate, the predicate in {@link
     * #includeDirectives(Predicate)}, the predicate in {@link #includeSchemaElement(Predicate)},
     * and the boolean in {@link #includeDirectiveDefinitions(boolean)} must be true for a
     * definition to be printed.
     *
     * @param includeDirectiveDefinition returns true if the definition should be printed
     * @return new instance of options
     */
    public Options includeDirectiveDefinitions(
        Predicate<GraphQLDirective> includeDirectiveDefinition) {
      return new Options(
          this.includeIntrospectionTypes,
          this.includeScalars,
    ...
    /**
     * Filter printing of type definitions. In Apollo Federation, some type definitions need to be
     * hidden, and this predicate allows filtering out such definitions. Prints all definitions by
     * default. Note that this predicate and the predicate in {@link
   ...
   * This must be guarded by a called to {@link #shouldPrintAsAst(TypeDefinition)}
   *
  ...
  private void printAsAst(
      PrintWriter out, TypeDefinition<?> definition, List<? extends TypeDefinition<?>> extensions) {
